...
var PortisProvider = /** @class */ (function () {
    function PortisProvider(opts) {
        ...
        this.isPortis = true;
        this.events = [];
        if (!utils_1.isLocalhost() && !opts.apiKey) {
    ...
    PortisProvider.prototype.createIframe = function () {
        ...
        return new Promise(function (resolve, reject) {
            var onload = function () {
                ...
                styleElem.innerHTML = style_1.css;
    ...
    PortisProvider.prototype.enqueue = function (payload, cb) {
        if (Array.isArray(payload)) {
            payload = payload.map(function (p) { return p.id = utils_1.randomId(); });
        }
        else {
            payload.id = utils_1.randomId();
        }
